...
set('application', 'erwmdevlab-www');
set('repository', 'https://github.com/erwinmapaliey/erwmdevlab-www.git');
...
host('production')
  ...
  ->set('port', 2210)
  ->set('deploy_path', '/var/www/erwmdevlab-www')
  ->setLabels([
      'type' => 'app',
      'env' => 'production',
  ]);
...
after('artisan:config:cache', 'filament:optimize');
